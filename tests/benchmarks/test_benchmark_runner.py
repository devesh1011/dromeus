...
from benchmarks.workloads.cifar10.resnet32 import MODEL_DEFINITION_HASH, MODEL_ID
...
def test_create_draft_uses_canonical_production_values() -> None:
    ...
    assert draft.require_iid_dataset().version == DATASET_VERSION
    assert draft.require_iid_dataset().preprocessing_hash == PREPROCESSING_HASH
